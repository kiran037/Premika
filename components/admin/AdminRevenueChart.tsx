  ...
  return (
    <div className="space-y-4">
      <div className="h-64 flex items-end justify-between gap-2 pt-6 pb-2 px-2 border-b border-gray-100">
        {data.map((point, idx) => {
          const heightPercent = Math.max(5, Math.min(100, Math.round((point.revenue / maxRevenue) * 100)));
          ...
          return (
            <div key={idx} className="flex-1 flex flex-col items-center gap-2 group h-full justify-end">
              ...
              <div
                ...
                className="w-full max-w-[36px] bg-indigo-500 group-hover:bg-indigo-600 rounded-t-md transition-all duration-300 min-h-[4px]"
              />
